...
public final class HelloRequest extends GeneratedMessageV3 implements HelloRequestOrBuilder {
    ...
    private HelloRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    public static HelloRequest parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
    ...
    public static final class Builder extends
        ...
        // Construct using com.rpc.grpc.helloworld.HelloRequest.newBuilder()
        private Builder() {
