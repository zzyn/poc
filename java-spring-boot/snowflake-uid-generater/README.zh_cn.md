...
<!-- 添加依赖 -->
<dependency>
    <groupId>com.ef.edtech.plugin</groupId>
    <artifactId>kt-uid-generater</artifactId>
    <version>1.0.0</version>
</dependency>
```

#### Application.java启动类配置
```java
@SpringBootApplication
@ComponentScan(basePackages = {"com.ef.edtech.platform.aadsvc", "com.baidu.fsg.uid"}) // 增加依赖包的扫描
...
#### application.yml配置(可选, 如未指定将采用默认值)
```yml
uid:
  timeBits: 28
  workerBits: 22
