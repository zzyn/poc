package com.sdk.feign;

import java.util.LinkedHashMap;
import java.util.Map;

import com.sdk.feign.auth.ApiKeyAuth;
import com.sdk.feign.auth.HttpBasicAuth;
import com.sdk.feign.auth.OAuth;
...
import com.sdk.feign.auth.OAuth.AccessTokenListener;
...
public class ApiClient {
  ...
  /**
   * Basic constructor for many auth name
   * @param authNames
   */
